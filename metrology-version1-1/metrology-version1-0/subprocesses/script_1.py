...
if __name__ == '__main__':
    ...
    with plt.style.context("bmh"):
        ...
        CORNER_PROTO = min(points, key=lambda point: math.hypot(67.0285-point[1], 23.3290-point[0]))    
    ...
    if switch == 1:
        ...
        HEIGHT_PROTO=profile_selector(CORNER_PROTO[0],1.1,verbose=0,plot=0,dataframe=df,z_params=z)
        print("#determined height limit is ",HEIGHT_PROTO)
        CORNER_PROTO_2=[CORNER_PROTO[0]-0.029,CORNER_PROTO[1]-0.044]
