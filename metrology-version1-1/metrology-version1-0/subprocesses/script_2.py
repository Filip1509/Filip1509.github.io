...
if __name__ == '__main__':
    ...
    with plt.style.context("bmh"):
        ...
        CORNER_PROTO = max(points, key=lambda point: math.hypot(1-point[1], 1-point[0]))    
    ...
    if switch == 1:
        ...
        print("#Success. Corner found at: ",CORNER_PROTO_2)
        print("{0},{1}".format(CORNER_PROTO_2[0],CORNER_PROTO_2[1]))
        plt.scatter(CORNER_PROTO[0], CORNER_PROTO[1], s=25, color='orange', marker="o")
