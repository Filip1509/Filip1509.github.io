...
C     
C     Generated by MadGraph5_aMC@NLO v. 3.4.0, 2022-05-07
...
C     
C     Process: a a > b b~ WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL FFV1_1(W(1,3),W(1,1),GC_1,MDL_MB, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),GC_1,AMP(1))
      CALL FFV1_2(W(1,4),W(1,1),GC_1,MDL_MB, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,3),W(1,2),GC_1,AMP(2))
